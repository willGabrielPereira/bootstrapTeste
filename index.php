                ...
                <div class="row">
                    <div class="col-12">
                        <div class="row align-items-center header">
                            <div class="col-md-auto bg-light shadow-lg rounded">
                                <?php echo $header; ?>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-4 border-right">
                            <form>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control form-control-sm" id="fone" placeholder="Fone">
                                </div>
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="col-6">
                                        <div class="input-group">
                                            ...
                                            <input type="repeat" class="form-control" id="repeat" placeholder="Repetir senha">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group"></div>
